...
public class DAOChuyenTau  extends UnicastRemoteObject implements IDAOChuyenTau {
    ...
    private static final ConcurrentHashMap<String, IUpdateChuyenTauManagerListener> listeners = new ConcurrentHashMap<>();
    ...
    @Override
    public void registerUpdateChuyenTauListener(String username, IUpdateChuyenTauManagerListener listener) throws RemoteException {
        System.out.println("Client đăng ký listener: " + username);
        listeners.put(username, listener);
    }

//    @Override
//    public void unregisterUpdateChuyenTauListener(String username) throws RemoteException {
...
//    }
    ...
    public ChuyenTau themChuyenTau(ChuyenTau chuyenTau) throws RemoteException{
        try {
            ...
            ChuyenTau result = query.getSingleResult();
            notifyAllListeners(chuyenTau);
            return result;
