...
public class Runner {
    ...
    private static void insertData(EntityManager em) {
        ...
        KhuyenMai km1 = new KhuyenMai(LocalDate.of(2025, 12, 27), LocalDate.of(2025, 12, 30), "Người hoạt động cách mạng", 0.10);
        ...
        KhuyenMai km2 = new KhuyenMai(LocalDate.of(2025, 12, 27), LocalDate.of(2025, 12, 30), "Thương binh", 0.15);
