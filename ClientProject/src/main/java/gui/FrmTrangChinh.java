...
public class FrmTrangChinh extends JFrame {
    ...
    public FrmTrangChinh(TaiKhoan taiKhoan, NhanVien nhanVien, IAuthService authService, UUID sessionId) throws RemoteException {
    ...
    private void setupUI() throws RemoteException {
        setTitle("Tàu Việt Express - " + nhanVien.getTenNV());
        setSize(1400, 720);
    ...
    private void checkDefaultPassword() {
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Lỗi kiểm tra mật khẩu: " + e.getMessage());
            }
        });
    }
        ...
        new Thread(() -> {
            while (true) {
                try {
                    ...
                    // Ping để duy trì session
                    boolean valid = authService.ping(taiKhoan.getMaTK(), sessionId);

                    if (!valid) {
                        SwingUtilities.invokeLater(() -> {
                            JOptionPane.showMessageDialog(FrmTrangChinh.this,
                    ...
                    System.err.println("Lỗi kiểm tra session: " + e.getMessage());
                    SwingUtilities.invokeLater(() -> {
                        JOptionPane.showMessageDialog(FrmTrangChinh.this,
    ...
    private void logoutAndExit() {
        try {
            authService.logout(taiKhoan.getMaTK());
        } catch (RemoteException e) {
                ...
                if (JOptionPane.showConfirmDialog(null,
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Lỗi khi mở màn hình đăng nhập: " + ex.getMessage(),
                                "Lỗi", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
...
//                    pnlChuyenTau = new PnlChuyenTau(nhanVien);
        ...
        JPanel navThongKe = createNavItem("images/icons/thong-ke.png", "Thống kê",pnlDangChon != null && pnlDangChon.equals(null));
