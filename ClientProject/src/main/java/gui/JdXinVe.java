...
public class JdXinVe extends CDialog implements MouseListener {
    ...
    private IDAOHoaDon daoHoaDon;
    private IDAOKhachHang daoKhachHang;
    private IDAOKhuyenMai daoKhuyenMai;
    ...
    public JdXinVe(PnlBanVe pnlParent, NhanVien nhanVien, HoaDon hoaDonTam) throws RemoteException {
        ...
        this.daoHoaDon = RemoteLookup.getRemote("hoaDonDao", IDAOHoaDon.class);
        this.daoVe = RemoteLookup.getRemote("veDao", IDAOVe.class);
        this.daoKhachHang = RemoteLookup.getRemote("khachHangDao", IDAOKhachHang.class);
        this.daoKhuyenMai = RemoteLookup.getRemote("khuyenMaiDao", IDAOKhuyenMai.class);
    ...
    public void luuHoaDon() throws RemoteException {
        ...
        luuThongTinVe();
        System.out.println("Lưu vé xong");
